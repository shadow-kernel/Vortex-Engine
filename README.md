...
| 🌍 **World building** | Scene hierarchy, prefabs, multi-viewport editing, camera preview, drag-&-drop asset placement, and full **Undo/Redo**. |
| 🕹️ **Input** | Unified keyboard, mouse and gamepad layer with cursor lock — ready for first/third-person controllers. |
| 🚀 **Ships with your game** | The engine is a static library; your exported game links it directly. No bloated runtime to redistribute. |
...
- Directional, point and spot lights (with ambient control)
- Procedural gradient/solid skybox with a configurable sun
- Editor grid, transform/rotation/scale gizmos, selection outline
- Wireframe mode, VSync, live FPS / draw-call / vertex stats
</details>
...
| 🚧 | **▶ Play in editor** — engine tick loop, real physics/audio/script systems |
| 🚧 | **Play in a separate window** (editor freezes, Unreal-style) |
| 🚧 | **Asset persistence & export** — `.vmesh`/`.vmat`, standalone game Player + "Build Game" |
| 🚧 | **Modern Apple-style UI** — clean, smooth, cohesive design system |
...
> See the live task board in-repo for the granular breakdown.
