...
namespace Editor.Editors.WorldEditor.Components.FileExplorer
{
    public partial class FileTreeView : UserControl
    {
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ...
            // DataContext �nderungen �berwachen
        ...
        /// <summary>
        /// Synchronisiert den Tree wenn ein Ordner in der Detail-Ansicht ge�ffnet wird.
        /// </summary>
        ...
        private void ExpandPathToItem(FileSystemItem targetItem)
        {
            ...
            // W�hle das gefundene Item aus UND klappe es auf
            currentItem.IsExpanded = true;
            currentItem.IsSelected = true;
        }
        ...
        /// <summary>
        /// L�dt Unterordner wenn ein TreeViewItem aufgeklappt wird.
        /// </summary>
        private void OnTreeViewItemExpanded(object sender, RoutedEventArgs e)
        {
            ...
            {
                // Lade Unterordner f�r alle Kinder (f�r das Anzeigen der Expander)
