...
namespace Editor.ECS.Components.Rendering
{
    ...
    public class MeshRenderer : Component
    {
        ...
        /// overlay pass — own FOV, cleared depth, no shadow casting), 2 = third-person only (what OTHERS
        ...
        public int RenderLayer
        {
            ...
            set
            {
                if (value < 0 || value > 2) value = 0;    // only 0/1/2 exist — sanitize stray values (incl. loaded scenes)
        ...
        /// Wird aufgerufen wenn Entity aktiv wird oder Mesh/Material sich �ndert.
        /// </summary>
