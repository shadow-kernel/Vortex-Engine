...
{
    /// <summary>
    /// Leichtgewichtiges Projekt-Manifest das nur Metadaten und Referenzen enth�lt.
    ...
    public class ProjectManifest
    {
        ...
        /// <summary>
        /// Project format/schema revision — the migration key. Bumped only when a change makes older projects
        ...
        /// <summary>
        /// ID der zuletzt ge�ffneten Szene (f�r Editor)
        /// </summary>
