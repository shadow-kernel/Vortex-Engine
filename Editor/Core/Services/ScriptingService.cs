...
@"// Auto-generated by Vortex Engine — the scripting API your behaviours build on.
// This grows as the engine exposes more to scripts. Edit your own scripts, not this file.
using System;
...
namespace Vortex
{
    ...
    /// <summary>Base class for all gameplay behaviours.</summary>
    public abstract class VortexBehaviour
    {
        ...
        /// <summary>Called once when play begins or the behaviour is created.</summary>
        public virtual void Start() { }

        /// <summary>Called every simulation tick. <paramref name=""dt""/> is seconds.</summary>
        public virtual void Update(float dt) { }

        /// <summary>Called when the behaviour is destroyed.</summary>
        public virtual void OnDestroy() { }
    }

    /// <summary>Input queries. The engine fills these in at runtime.</summary>
